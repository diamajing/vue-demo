<template>
  <div>
    ...
    <div style="overflow: hidden;">
      <div class="echarts">
        <IEcharts :option="line" class="echarts" ></IEcharts>
      </div>
      <div class="echarts">
        <IEcharts :option="bar"  class="echarts" ></IEcharts>
      </div>
      <div class="echarts">
        <IEcharts :option="pie"  class="echarts" ></IEcharts>
      </div>
      <div class="echarts">
        <IEcharts :option="pie_radius" class="echarts"></IEcharts>
      </div>
    </div>
  </div>
</template>
